...
public class MTVStatement implements Statement {
	...
	MTVStatement(MTVConnection conn, int id, int resultSetType, int resultSetConcurrency, boolean closeWithResultSet) {
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		...
		try {
			...
			result = io.multiversum.db.executor.Executor.singleExecution(sql, options);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public int executeUpdate(String sql) throws SQLException {
		connection.getSqlCommands().add(sql);
